...
def execute(filters=None):
	...
	jsonString_col = json.dumps(sle, indent=4, sort_keys=True, default=str)
	f3= open("/home/demo9t9it/frappe-bench/apps/pos_bahrain/pos_bahrain/pos_bahrain/report/insta_shop_items/txt/sle.txt","w+")
	...
	f3= open("/home/demo9t9it/frappe-bench/apps/pos_bahrain/pos_bahrain/pos_bahrain/report/insta_shop_items/txt/total_data.txt","w+")
	f3.write(jsonString_col)
...
def get_columns(filters):
	...
	columns = [
		...
		{"label": _("WHC"), "fieldname": "warehouse_code", "fieldtype": "Data", "width": 100}
	]
...
def get_stock_ledger_entries(filters, items):
	...
	return frappe.db.sql("""
		select
			sle.item_code, warehouse, wh.pb_insta_warehouse_code AS whc, sle.posting_date, sle.actual_qty, sle.valuation_rate,
			sle.company, sle.voucher_type, sle.qty_after_transaction, sle.stock_value_difference,
			sle.item_code as name, sle.voucher_no, sle.stock_value
		from
			`tabStock Ledger Entry` sle force index (posting_sort_index)
		LEFT JOIN
			`tabWarehouse` AS wh ON wh.name = sle.warehouse
...
def get_item_warehouse_map(filters, sle):
	...
	iwb_d = remap_keys(iwb_map)
	jsonString_col = json.dumps(iwb_d, indent=4, sort_keys=True, default=str)
	f3= open("/home/demo9t9it/frappe-bench/apps/pos_bahrain/pos_bahrain/pos_bahrain/report/insta_shop_items/txt/iwb_map_dump.txt","w+")
	f3.write(jsonString_col)
